                                ...
                                <div class="col-lg-8 col-md-10 mx-auto">
                                    <div class="card mt-4">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/category/' . $categorys->id) }}" method="post" class="custom-validation">
                                                {!! csrf_field() !!}
                                                @method("PATCH")
                                                <div class="form-group ">
                                                    <label class=" lable-product">Name</label>
                                                    <div>
                                                        <input class="form-control input-product" name="name" value="{{$categorys->name}}" >
                                                    </div>
                                                </div>
                                                <div class="form-group mt-4">
                                                    <label class="lable-product">Tag</label>
                                                    <div>
                                                        <input class="form-control input-product" name="description" value="{{$categorys->description}}">
                                                    </div>
                                                </div>
