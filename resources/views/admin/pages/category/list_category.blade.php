                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="bg-gradient-primary mt-n4 mx-3 shadow-primary border-radius-lg pt-4 pb-3" style="display: flex; justify-content: space-between;">
                            ...
                            <h6 class="text-white add-product-item text-capitalize ps-3 me-5"> <button class="btn btn-primary"> <a href="{{ url('category/create') }}" class="text-white">Add Product</a> </button> </h6>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    @foreach($categorys as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning"> <a class="btn-warning" href="{{url('/category/' . $category->id . '/edit')}}">Edit</a></button>
