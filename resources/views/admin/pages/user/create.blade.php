                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('user') }}" method="post" class="custom-validation">
                                                ...
                                                <div class="form-group ">
                                                    <label class=" lable-product form-label">Name</label>
                                                    <div>
                                                        <input class="form-control input-product" name="name" >
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class=" lable-product form-label">Email</label>
                                                    <div>
                                                        <input class="form-control input-product" name="email" >
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class=" lable-product form-label">Role</label>
                                                    <div>
                                                        <input class="form-control input-product" name="role" >
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class=" lable-product form-label">Password</label>
                                                    <div>
                                                        <input type="password" class="form-control input-product" name="password" >
                                                    </div>
                                                </div>
