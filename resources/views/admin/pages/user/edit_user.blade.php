                                ...
                                <div class="col-lg-8 col-md-10 mx-auto">
                                    <div class="card mt-4">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/user/' . $users->id) }}" method="post" class="custom-validation">
                                                {!! csrf_field() !!}
                                                @method("PATCH")
                                                <div class="form-group ">
                                                    <label class=" lable-product">Name</label>
                                                    <div>
                                                        <input class="form-control input-product" name="name" value="{{$users->name}}">
                                                    </div>
                                                </div>
                                                <div class="form-group mt-4">
                                                    <label class="lable-product">Email</label>
                                                    <div>
                                                        <input class="form-control input-product" name="email" value="{{$users->email}}">
                                                        {{--                                                        <select name="" id="" value="{{$products->category->name}} ></select>--}}
                                                    </div>
                                                </div>
                                                <div class="form-group mt-4">
                                                    <label class="lable-product">Password</label>
                                                    <div>
                                                        <input class="form-control input-product" name="password" value="{{$users->password}}">
                                                    </div>
                                                </div>
n
